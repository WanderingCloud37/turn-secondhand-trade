...
INSERT [dbo].[goods] ([goods_id], [title], [price], [description], [status], [created_time], [category_id], [seller_id], [audit_admin_id], [audit_time], [is_deleted]) VALUES (1, N'高等数学（第七版）上下册', CAST(35.00 AS Decimal(10, 2)), N'九成新，少量笔记，配套课后答案', N'已售', CAST(N'2026-06-12T14:50:36.000' AS DateTime), 3, 3, NULL, NULL, 0)
INSERT [dbo].[goods] ([goods_id], [title], [price], [description], [status], [created_time], [category_id], [seller_id], [audit_admin_id], [audit_time], [is_deleted]) VALUES (3, N'宿舍床上书桌', CAST(25.00 AS Decimal(10, 2)), N'可折叠，九成新，送防滑垫', N'已售', CAST(N'2026-06-12T14:50:36.000' AS DateTime), 6, 5, NULL, NULL, 0)
...
INSERT [dbo].[goods] ([goods_id], [title], [price], [description], [status], [created_time], [category_id], [seller_id], [audit_admin_id], [audit_time], [is_deleted]) VALUES (5, N'羽毛球拍一对', CAST(50.00 AS Decimal(10, 2)), N'胜利品牌，用了半年，送3个羽毛球', N'已售', CAST(N'2026-06-12T14:50:36.000' AS DateTime), 7, 4, NULL, NULL, 0)
INSERT [dbo].[goods] ([goods_id], [title], [price], [description], [status], [created_time], [category_id], [seller_id], [audit_admin_id], [audit_time], [is_deleted]) VALUES (6, N'全新口红 豆沙色', CAST(69.00 AS Decimal(10, 2)), N'仅试色，包装盒齐全', N'已售', CAST(N'2026-06-16T09:25:00.000' AS DateTime), 4, 6, NULL, NULL, 0)
INSERT [dbo].[goods] ([goods_id], [title], [price], [description], [status], [created_time], [category_id], [seller_id], [audit_admin_id], [audit_time], [is_deleted]) VALUES (7, N'人体工学电竞椅', CAST(120.00 AS Decimal(10, 2)), N'坐了半年，无破损，可调节高度', N'已售', CAST(N'2026-06-16T09:28:00.000' AS DateTime), 6, 5, NULL, NULL, 0)
INSERT [dbo].[goods] ([goods_id], [title], [price], [description], [status], [created_time], [category_id], [seller_id], [audit_admin_id], [audit_time], [is_deleted]) VALUES (8, N'计算机四级全套复习资料', CAST(28.00 AS Decimal(10, 2)), N'纸质习题+网课电子讲义', N'已售', CAST(N'2026-06-16T09:30:00.000' AS DateTime), 3, 6, NULL, NULL, 0)
